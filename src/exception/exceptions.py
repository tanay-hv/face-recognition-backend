...
class BadRequest(BaseException):
    def __init__(self, message: str = "Bad Request"):
        super().__init__(status_code=400, error_code=400, message=message) 

class NotFound(BaseException):
    def __init__(self, message: str = "Resource not found"):
        super().__init__(status_code=404, error_code=404, message=message) 
...
class DuplicateEntry(BaseException):
    def __init__(self, message: str = "Duplicate Entry"):
        super().__init__(status_code=409, error_code=409, message=message) 

class InternalServer(BaseException):
    def __init__(self, message: str = "Internal server error"):
        super().__init__(status_code=500, error_code=500, message=message) 

class ServiceUnavailable(BaseException):
    def __init__(self, message: str = "Service unavailable"):
        super().__init__(status_code=503, error_code=503, message=message) 